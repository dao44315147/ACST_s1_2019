...
# However, the R squared is higher than the single regression of exp state a better fit, but still less than 0.5 so not good enough.
...
# The R squared is also increase to 0.3517, still <0.5, not a good fit.
